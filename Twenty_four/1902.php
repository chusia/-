...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href="../recipe/19the Beginning of Winter.html"><p Align=center><img src="../img/seasons/1902.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">麻油雞糯米飯</a></h1> 
...
<p>材料:</p>
<p>長糯米3杯(435g),去骨雞腿肉400g(約2支),
薑片5-6片,冷水330g雞肉醃料:米酒1大匙,鹽1/2茶匙</p>
<p>調味料:</p>
<p>麻油4大匙,鹽1茶匙,米酒1/4杯(約45g)</p>
<p>步驟:</p>
<p>1.去骨雞腿肉切成一口大小塊狀,加上雞肉醃料混合均勻醃漬20分鐘</p>
<p>2.長糯米洗乾淨將水濾掉(水份都儘量濾乾,糯米不用泡,洗乾淨就可以)</p>
<p>3.鍋中倒入4大匙麻油,薑片放入爆香、將雞肉塊加入炒至變色、加入長糯米及調味料混合均勻</p>
<p>4.最後將冷水加入煮滾就關火,此時嚐一下味道,依照自己喜歡鹹度調整</p>
<p>5.將所有材料盛到電鍋內鍋中,外鍋加1杯水(約180g)壓一次煮第一次</p>
<p>6.跳起之後將油飯翻鬆(底部的要翻上來),外鍋再加1杯水煮第二次、跳起再悶30分鐘即可</p>
 ...
 <P><a href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../img/11.png
	...
	<?php include_once('HotRecipe.php');?>
    </ul>
	</div>
	<script type="text/javascript">
	function setSN(e){
