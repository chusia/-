...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/505.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">豬肝菠菜湯</a></h1> 
	...
	<div class="entry-site"> 
<P>材料：</P>
<P>鮮豬肝250克，菠菜200克，清湯、麻油、味精、精鹽各適量適量</P>
...
<P>1.將豬肝、菠菜分別洗乾淨，豬肝切成均勻薄片，菠菜切成段
</P>

將清湯放入鍋內燒開後，下入豬肝、菠菜，加入味精、精鹽

</p>

<P>3. 待湯再開時，淋上少許麻油即成。佐餐食用，適量</P>
...
<P>補血養肝明目。適合肝血虧虛所致的頭暈眼花、兩目乾澀、視物模糊、視力減退、迎風流淚，以及貧血、夜盲症、中心性視網膜炎等而屬肝血虛者食用。</P>
