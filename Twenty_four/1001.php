...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1001.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">清炒馬齒莧</a></h1> 
...
<P>將馬齒莧洗淨，切成3厘米長，入沸水鍋內焯水後撈出，瀝干水分；蒜子、姜切末。鍋置旺火上，放入色拉油，燒至七成熱，下姜、蒜末煸香，放入馬齒莧，加鹽翻炒均勻，淋香油，出鍋裝盤即可</P>
