...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1606.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">當歸燉子雞</a></h1> 
	...
	<div class="entry-site"> 
          <p>材料 :</p><P>當歸30克，子母雞1隻。
</p>
                    <p>制作:</p><P> 將子母雞宰殺去毛、去肚腸。將當歸填入雞腹，放入砂鍋中，加水適量，先大火煮沸，打去浮沫，再小火煨至爛熟。

</p>
                    <p>功效 : </p><P>補血益氣，和胃止痛。</p>
