...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1508.jpg
                        " alt="Gallery"></p></a>
	</a> 
...
<div class="title-heavy"></div> 
	...
	<div class="entry-site"> 
<p>材料 :</p><P> 柚子（越冬最佳）一個，公雞一隻，精鹽適量</p>
                    <p>制作：</p><P>公雞去毛、內臟洗靜，柚子去皮留肉。將柚子放入雞腹內，再放入氣鍋中，上鍋蒸熟，出鍋時加入精鹽調味即可。</p>
                   <p>功效：</p><P>補肺益氣，化痰止咳。</p>
。
