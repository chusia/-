...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1608.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">瓊玉露</a></h1> 
	...
	<div class="entry-site"> 
          <p>材料 :</p><P> 人參15克、生地60克、茯苓30克、蜜糖30克
</p>
                    <p>制作 :</p><P>生地洗凈切成小粒;茯苓碎成小粒洗凈，放進瓦煲，加入清水1500毫升(約6碗水量)煲1個小時，至湯約400毫升(約1碗半水量)，用燉盅盛裝，把人參洗凈切片，放進燉盅內加蓋，文火隔水燉3-4小時，取出待稍涼，溶入蜜糖則成，此量可供1-2人用，深秋時宜每周1-2次。</p>
