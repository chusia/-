...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">黑豆羊肉燉當歸</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="2007.php"><img src="../img/seasons/2007.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	
	黑豆羊肉燉當歸是一道美味的菜肴，羊肉性溫味甘，既可食補，又可食療，為優良的強壯祛疾食品，有益氣補虛，溫中暖下，補腎壯陽，生肌健力，抵禦風寒......	
	...
	<span class='page-numbers current'>1</span><a class='page-numbers' href='20_1.php' title='第 2 頁'>2</a><a class='page-numbers' href='' title='下頁'>上頁</a></div>
	</nav> 
	</div> 
	<!-- #primary --> 
