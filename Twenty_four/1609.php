...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1609.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">蘿蔔杏仁煮牛肺</a></h1> 
	...
	<div class="entry-site"> 
        <p>材料 : </p><P>蘿蔔500克，苦杏仁15克，牛肺250克。
</p>
                    <p>制作 :</p><P>蘿蔔切塊，杏仁去皮尖。牛肺用開水燙過，再以薑汁、料酒旺火炒透。瓦鍋內加水適量，放入牛肺、蘿蔔，杏仁，煮烹即成。
</p>
