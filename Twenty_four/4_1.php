...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<nav class="crumbs">現在位置： <a title="返回首頁" href="">首頁</a> &gt; <a href="" title="">節氣養生</a> &gt; <a href="" title="觀看分類「節氣養生」的全部文章">冬季</a> &gt;春分 </nav> 
	...
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">山藥扁豆鯉魚湯</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="407.php"><img src="../img/seasons/407.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	春分是一年四季中阴阳平衡、昼夜均等、寒温各半的时期，此时，人体血液处于旺盛时期，激素水平也处于相对高峰期，此时易引发一些非感染性疾病。人们在保健养生时应注意保持人体的阴阳平衡状态。保持轻松愉快，乐观向上的精神状态.....	
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀雨水">薑蔥鯇魚</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="482.php"><img src="../img/seasons/408.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	薑蔥魚腩煲. 材料: 鯇魚腩 1件 (魚較位最好味); 硬豆腐 1件(無加); 紅蔥頭 1粒; 蔥 2-3條(切段); 薑 6-7片; 蒜 2-3小粒. 魚調味 : 生抽 少許; 胡椒粉 少許; 糖 少許. 調味 : 生抽 1湯匙; 蠔油 1湯匙; 糖 少許; 酒 少許; 水 少許; 麻油 少許(最後落). 做法: 鯇魚腩洗淨 .......
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
     <div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 驚蟄">茯苓粥</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="409.php"><img src="../img/seasons/409.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	茯苓的药用价值很高，经常食用能增强人体的免疫功能，其被誉为中药“四君八珍”之一，也是中老年人延年益寿的良药。此外，茯苓性味甘淡平，入心、肺、脾经，其具有渗湿利水，健脾和胃，宁心安神的功效。可见，茯苓粥的功效极佳.......	
	...
	<span class='page-numbers current'>1</span><a class='page-numbers' href='4_2.php' title='第 2 頁'>2</a><a class='page-numbers' href='4.php' title='下頁'>上頁</a></div>
	</nav> 
	</div> 
	<!-- #primary --> 
