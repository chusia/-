...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<nav class="crumbs">現在位置： <a title="返回首頁" href="">首頁</a> &gt; <a href="" title="">節氣養生</a> &gt; <a href="" title="觀看分類「節氣養生」的全部文章">冬季</a> &gt; 處暑 </nav> 
	...
	<a href=""><p Align=center><img src="../img/seasons/1404.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">清炒山藥</a></h1> 
...
<P>戴手套給山藥去皮，斜切成段，再把段豎切成菱形片，放入水中洗掉粘液， 胡蘿蔔也這樣切，菜心也切段。鍋中燒開水，下入山藥和胡蘿蔔燙至水再次開起，撈出，菜心燙一下馬上撈出。重新起鍋下少許油，下燙好的蔬菜加1/2小匙鹽大火快速炒勻出鍋即可
