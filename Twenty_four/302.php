...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/302.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">淡菜粳米粥</a></h1> 
...
<P>1. 將淡菜洗淨，粳米除去雜質，洗淨</P>

<P>2. 將淡菜、粳米放入鍋內。加水適量。置武火上燒開</P>

<p>3. 然後改用文火熬煮30~40分鐘，待粥熟後即成</p>
...
<P>適用于虛勞贏瘦、眩暈、盜汗、陽痿、腰痛、吐血、崩漏、帶下、癭瘤者</P>
