...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/104.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">柴胡排骨湯</a></h1> 
...
<P>2.取一電鍋，將中藥包與排骨一起放置於內鍋</P>

<p>3.接著在內鍋裡加入約1000C.C.的水，外鍋則加入3杯水開始燉煮</P>

<P>4.待排骨燉煮至軟爛後，再依照個人口味加入鹽巴即可關火</P>
