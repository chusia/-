...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1502.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">大枣乌梅汤</a></h1> 
	...
	<div class="entry-site"> 
<p>材料 :</p><P>大枣20克，乌梅20克，冰糖适量。</p>
                    <p>制作 ：</p><P>将大枣、乌梅洗干净，人沙锅加水适量，文火煎取浓汁，兑入冰糖溶化即成。</p>
                   <p>功效 ：</p><P>滋阴、益气、敛汗</p>
                   <p>用法：</p><P>阴津亏虚所致的烦热口渴、气短神疲、盗汗不止等。
