...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1701.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">拔絲山藥</a></h1> 
...
<P>步驟:</P>
<p>
將山藥削皮洗凈，切成滾刀塊，備用。植物油燒至五成熱，把山藥放入油內炸透，至金黃色，撈出，控淨餘油。用清水將白糖化開，用慢火炒至白糖由稠變稀，能拔絲時，倒入山藥，離開火眼，顛翻炒勻，使糖汁完全粘在山藥上後，倒在抹香油的盤子內即可</p>
