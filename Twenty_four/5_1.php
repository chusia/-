...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">香椿芽拌豆腐</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="507.php"><img src="../img/seasons/507.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	香椿芽拌豆腐是一款家常菜品，制作原料主要有香椿芽、豆腐、香油，精盐等，制作简单，清凉爽口。营养价值非常高，富含丰富的蛋白质
.....	
	...
	<span class='page-numbers current'>1</span><a class='page-numbers' href='5_1.php' title='第 2 頁'>2</a><a class='page-numbers' href='5.php' title='下頁'>上頁</a></div>
	</nav> 
	</div> 
	<!-- #primary --> 
