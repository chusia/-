...
<!DOCTYPE html> 
	...
	<link rel='stylesheet' id='style-css' href=../css/style1.css>
...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/2101.jpg
                        " alt="Gallery"></p></a>
	...
	</div><span class="meta-site"> 
	<!-- .entry-meta --> 
	</span></div><span class="meta-site"> 
	<!-- .entry-content --> 
	</span></section><span class="meta-site"> 
	<!-- #content --> 
	</span></article><span class="meta-site"> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">蔥爆羊肉</a></h1> 
	...
	<div class="entry-site"> 
<P>材料：</P>
<P>羊肉250克，蔥白3段，色拉油適量，食鹽1茶匙，料酒1湯匙，生抽1湯匙，白糖2克</P>
...
<P>1.羊肉片化冰備用;蔥白斜刀切絲備用</P>

<P>2.鍋中倒入適量的炒菜油，比平時可以稍微多一些，油溫約5-6成熱左右</P>
<P>3.放入化冰後的羊肉片，迅速滑散翻炒，烹入料酒</P>
<P>4.待羊肉片開始陸續變白時，加入蔥絲繼續快手翻炒均勻</P>
<P>5.放入生抽，白糖，鹽炒勻即可出鍋</P>
<P>功效：</P>
<P>養胃、溫補肝腎、溫經止痛、健胃護眼、增強抵抗力</P>
	...
	<?php include_once('../Login/Guestbook.php'); //留言板?>
	...
	<!-- .entry-meta --> 
	</span></span></span></div><span class="meta-site"><span class="meta-site"><span class="meta-site"> 
	<!-- .entry-content --> 
	</section> 
	<!-- #content --> 
   ...
   <script type='text/javascript'>
	...
	<div class="clear"></div><aside id="text-3" class="widget widget_text"><h3 class="widget-title"><p><i class="icon-st"></i></p>AD</h3> <div class="textwidget">
	...
	<div class="clear"></div></aside> </span></span></span></div><span class="meta-site"><span class="meta-site"><span class="meta-site"> 
	<div class="clear"></div> 
	...
	<fieldset id="inputs"> 
	<input id="username" type="text" name="log" placeholder="名稱" required> 
	<input id="password" type="password" name="pwd" placeholder="密碼" required> 
	</fieldset> 
	<fieldset id="actions"> 
