...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1607.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">豬肉燉墨魚</a></h1> 
	...
	<div class="entry-site"> 
         <p>材料 : </p><P>小墨魚(烏賊)2個，鮮瘦豬肉250克，食鹽3克。
</p>
                    <p>制作 : </p><P>將墨魚、豬肉洗凈後同燉，爛熟後加食鹽。</p>
                    <p>功效:</p><P>滋陰補陽，強筋健骨。</p>
