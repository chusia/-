...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1507.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">貝母甲魚</a></h1> 
	...
	<div class="entry-site"> 
<p>材料 :</p><P> 活甲魚1隻（約500～1000克），川貝母5克，料酒、細蔥、花椒粉、精鹽各適量。</p>
                    <p>制作 :</p><P> 先將甲魚放人溫熱水中，使其排盡尿，然後剁去頭，剖除內臟，清洗乾淨。將甲魚放入蒸缽中，加水適量，放人貝母、料酒、花椒粉、細蔥、味精、精鹽，以武火蒸熟即成。</p>
                   <p>功效 :</p><P> 滋陰補肺、化痰止咳(陰虛所致久咳痰多、氣短喘促、夜臥盜汗、心煩口渴、低熱不退等。)</p>
