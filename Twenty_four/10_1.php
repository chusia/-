...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">山藥蓮子湯</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="1007.php"><img src="../img/seasons/1007.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	山藥蓮子湯有益氣健脾、除濕止帶的作用，對於運行失常所導致的精神疲倦、困重乏力、食慾不振、大便溏瀉等症狀均有一定的療效
.....	
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀雨水">荷葉茯苓粥</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="1008.php"><img src="../img/seasons/1008.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	...
	<span class='page-numbers current'>1</span><a class='page-numbers' href='10_1.php' title='第 2 頁'>2</a><a class='page-numbers' href='10.php' title='下頁'>上頁</a></div>
	</nav> 
	</div> 
	<!-- #primary --> 
