...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">青椒炒鴨塊</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="807.php"><img src="../img/seasons/807.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	椒炒鴨肉是一道家常菜，主要原料是鴨肉和青椒，葷素搭配，符合大眾口味。青椒炒鴨肉怎麼做?它的做法如下：菜品做法1、將鴨腿肉片下來切成條，將切好的鴨肉
.....	
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀雨水">荸薺冰糖藕羹</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="808.php"><img src="../img/seasons/808.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	荸薺冰糖藕羹是一道美味的食譜，營養價值豐富，荸薺冰糖藕羹的做法有哪些？荸薺冰糖藕羹怎麼做好吃  .......
	...
	<span class='page-numbers current'>1</span><a class='page-numbers' href='8_1.php' title='第 2 頁'>2</a><a class='page-numbers' href='8.php' title='下頁'>上頁</a></div>
	</nav> 
	</div> 
	<!-- #primary --> 
