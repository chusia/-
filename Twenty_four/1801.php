...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1801.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">山藥排骨湯</a></h1> 
...
<P>步驟:</P>
<p>
１、將排骨放入鍋中，加水燒沸、汆燙，撈淨浮沫。</p><P>
２、將新鮮山藥洗淨，削去外皮，切成滾刀塊。</P><P>
３、將排骨、山藥一同放入鍋中，加適量水，以大火燒開後轉小火煮，待排骨熟透後加鹽調味即可。
</p>
