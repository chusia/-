...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/808.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">荸薺冰糖藕羹</a></h1> 
...
<P>步驟:</P>
<P>
荸薺洗凈去皮，藕洗凈切小塊。沙鍋加水適量，將荸薺、藕同入鍋內文火煮燉20分鍾時，加入冰糖再燉lO分鍾，·起鍋即可食用
</P>
