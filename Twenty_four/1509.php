...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1509.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">香酥山药</a></h1> 
	...
	<div class="entry-site"> 
<p>材料 :</p><P>鲜山药500克，白糖125克，豆粉100克，植物油750克（实耗150克），醋、味精、淀粉、香油各适量。</p>
                    <p>制作 ：</p><P>山药洗静，上锅蒸熟，取出后去皮，切1寸长段，再一剖两片，用刀拍扁。锅烧热倒入植物油，等油烧至七成热时，投入山药，炸至发黄时捞出待用。另烧热锅，放入炸好的山药，加糖和水两勺，文火烧5、6分钟后，即转武火，加醋、味精，淀粉勾芡，淋上香油起锅装盘即成。</p>
                   <p>功效:</p>.<P> 健脾胃，补肺肾。对于脾虚食少，肺虚咳嗽、气喘者更为适合。</p>
