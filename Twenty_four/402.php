...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/402.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">豬肺橄欖湯</a></h1> 
...
<P>根據中醫以髒補髒之理，豬肺被認為有潤肺、補肺虛、止咳嗽的功效;橄欖具有清肺利咽、生津止渴的功效;石斛有生津益胃，清熱養陰的作用;無花果具有潤肺止咳、清熱潤腸的功效。此湯甘甜清香，具有養陰、潤肺、化痰、止咳的作用，適合肺虛咳嗽的患者飲用</P>
