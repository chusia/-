...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1602.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">白果菊花雪梨飲</a></h1> 
	...
	<div class="entry-site"> 
        <p>材料 :</p><p> 白果20克、白菊花4朵、雪梨3個、鮮牛奶或淡牛奶250-350毫升、蜜糖適量。
</p>
                    <p>制作 :</p><p>白果去殼，用開水燙去衣、去心;白菊洗凈，摘取花瓣;雪梨削皮去心，切成粒狀。先把白果、雪梨放入開水鍋里，水分不宜太多，文火煲至白果熟透，加入白菊、鮮牛奶或淡牛奶稍滾，熄火稍降溫後，加入適量的蜜糖調成甜湯，此量可供2-3人用。
</p>
