...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">菊花鱔魚</a></h1> 

	</header> 
	<!-- .entry-header --> 
	<div class="entry-content"> 
	<figure class="thumbnail"> 
	<a href="607.php"><img src="../img/seasons/607.jpg
                        " alt="Gallery"></a>
	</a> 
	</figure> 
	<div class="entry-site"> 
	鱔魚宰殺、剖腹去內臟，去骨去皮，切成2寸5分長片塊，用刀頂頭斜批成兩片(末端不批短)，再直切成條狀(一頭不切斷)加黃酒、鹽、蔥、姜浸漬起來，然後再逐個排上幹.
.....	
	...
	<span class='page-numbers current'>1</span><a class='page-numbers' href='6_1.php' title='第 2 頁'>2</a><a class='page-numbers' href='6.php' title='下頁'>上頁</a></div>
	</nav> 
	</div> 
	<!-- #primary --> 
