...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1603.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">青紅蘿蔔煲生魚</a></h1> 
	...
	<div class="entry-site"> 
         <p>材料:</p><P> 白蘿蔔300克、紅蘿蔔300克、生魚1條(約500克)、豬瘦肉100克、紅棗6個、生薑3片。
</p>
                    <p>制作 :</p><P> 紅、白蘿蔔去皮洗凈，切為厚塊;紅棗洗凈去核稍浸泡;豬瘦肉整塊洗凈;生魚去鱗、鰓、內臟，洗凈，晾乾水，下油鍋微火稍煎至微黃。然後一起放入瓦煲內，加入清水2500毫升(約10碗水量)，武火煮沸後，文火煲兩個小時，加入適量食鹽便可，此量可供2-4人用。</p>
                    <p>功效：</p><P>補肺，清肺，降氣，除痰。</p>
