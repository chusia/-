...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1601.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">天門冬粥</a></h1> 
	...
	<div class="entry-site"> 
         <p>材料 : </p><p>天門冬20 克，粳米100 克，冰糖。
</p>
                    <p>制作 :</p><p>將天門冬搗碎，放入砂鍋內，加水煎取濃汁，去渣，2.將米洗凈，連同煎汁一起放入砂鍋內，加適量水，大火煮沸，改為小火煮約30 分鐘成粥，用糖調味即成。</p>
                    <p>功效:</p><p>潤肺生津，養腎補虧。天門冬粥是很好的健美食品，還可作為肺腎陰虛病人的食療粥。</p>
                 <!--  <p>用法 ：每日早、晚温热服食。
                   </p>
                   <p>應用 ：陰兩虛所致的心悸氣短、煩渴神疲、久病形瘦、失眠健忘、心神不寧、食欲不振、久咳聲低、乾咳少痰，以及神經衰弱、癔病、慢性支氣管炎、肺氣腫、肺結核、支氣管擴張、百日咳等而屬氣陰虧虛者。</p>-->
                   <p>注意 : </<p>脾胃虛寒，食少便溏，神疲乏力者，不可食用。</p>
