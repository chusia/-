...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/202.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">菊花粥</a></h1> 
...
<P>2.鍋中加入適量清水，放入粳米和菊花</P>

<p>3.大火燒開後轉小火慢慢熬煮，待粥將熟時放入冰糖，融化後攪拌均勻即成</P>
