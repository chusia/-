...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/806.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">冬瓜草魚煲</a></h1> 
...
<P>步驟:</P>
<P>
冬瓜去皮，洗凈切三角塊，草魚剖凈，留尾洗凈待用。先用油將草魚(帶尾)煎至金黃色，取沙鍋一個，其內放入清水適量，把魚、冬瓜一同放入沙鍋內，先武火燒開後，改用文火燉至2小時左右，湯見白色，加入食鹽、味素調味即可食用
</P>
