...
<?php include_once('../Login/User.php'); //登入欄位?>
	...
	<a href=""><p Align=center><img src="../img/seasons/1605.jpg
                        " alt="Gallery"></p></a>
	</a> 
	...
	<section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	 <header class="entry-header"> 
<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀小雪">黃精粥</a></h1> 
	...
	<div class="entry-site"> 
         <p>材料 :</p><P> 黃精15～30克(或鮮黃精30～60克)，粳米60克，白糖適量。
</p>
                    <p>制作 :</p><P>黃精切片，煎取濃汁，去渣，同粳米煮粥，粥成後加白糖適量即可食。每日1劑。
</p>
                    <p>功效:</p><P>滋陰潤肺，平咳去痰。</p>
