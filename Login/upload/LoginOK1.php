...
<!DOCTYPE html> 
    ...
    <li id="menu-item-61442" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-61442"><a href="">今日天氣</a></li>
...
<p><?php echo $row_Recordset1['UserName']; ?>您在<?php echo $now_solar_terms?>時節欲改善&nbsp;&nbsp;<u><?php if($row_Recordset1['Liver'] == 'N' && $row_Recordset1['Kidney'] == 'N' && $row_Recordset1['Stomach'] == 'N' && $row_Recordset1['Lung'] == 'N' && $row_Recordset1['Heart'] == 'N'){
		echo '暫時不需要';
	} else {
		if($row_Recordset1['Liver'] == 'Y'){
			echo "肝";
    ...
    ?></u>，體質為&nbsp;&nbsp;<u><?php if($row_Recordset1['Allergy'] == 'N' && $row_Recordset1['Gout'] == 'N' && $row_Recordset1['Insomnia'] == 'N' && $row_Recordset1['Fat'] == 'N'){
		echo '你很健康';
	} else {
		if($row_Recordset1['Allergy'] == 'Y'){
			echo "過敏體質";
...
//====================過敏=========================
	...
	if($row_Recordset1['Liver'] == 'N' && $row_Recordset1['Kidney'] == 'N' && $row_Recordset1['Stomach'] == 'N' && $row_Recordset1['Lung'] == 'N' && $row_Recordset1['Heart'] == 'N'){//都沒勾的話
...
?>
<!--=========================活動標題====================-->
<p>您的喜好活動為&nbsp;&nbsp;<u><?php if($row_Recordset1['Artistic'] == 'N' && $row_Recordset1['Educative'] == 'N' && $row_Recordset1['Outdoor'] == 'N' && $row_Recordset1['Movement'] == 'N' && $row_Recordset1['Family'] == 'N'){
		echo '暫時不需要';
	} else {
		if($row_Recordset1['Artistic'] == 'Y'){
			echo "藝文活動";
...
if($row_Recordset1['Artistic'] == 'Y'){
	...
	$sql="Select * From `act` WHERE ACT_type = '藝文活動' AND ACT_date >= now()";
	$result = mysql_query($sql,$gsgf) or die("run error");
	$i = 0;
?>
	<tr>
...
if($row_Recordset1['Educative'] == 'Y'){
	...
	$sql="Select * From `act` WHERE ACT_type = '教育活動' AND ACT_date >= now()";
	$result = mysql_query($sql,$gsgf) or die("run error");
	$i = 0;
?>
	<tr>
...
if($row_Recordset1['Outdoor'] == 'Y'){
	...
	$sql="Select * From `act` WHERE ACT_type = '戶外遊憩' AND ACT_date >= now()";
	$result = mysql_query($sql,$gsgf) or die("run error");
	$i = 0;
?>
	<tr>
...
if($row_Recordset1['Movement'] == 'Y'){
	...
	$sql="Select * From `act` WHERE ACT_type = '運動競技' AND ACT_date >= now()";
	$result = mysql_query($sql,$gsgf) or die("run error");
	$i = 0;
?>
	<tr>
...
if($row_Recordset1['Family'] == 'Y'){
	...
	$sql="Select * From `act` WHERE ACT_type = '親子休閒' AND ACT_date >= now()";
	$result = mysql_query($sql,$gsgf) or die("run error");
	$i = 0;
?>
	<tr>
...
?>
 ...
 <P><a href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/11.png
	...
	<div class="clear"><?php include_once('AQIRemind.php');?></div></aside><aside id="hot_post-3" class="widget widget_hot_post"><h3 class="widget-title"><p><i class="icon-st"></i></p>我的最愛</h3>
