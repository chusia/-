...
$sql = "SELECT * FROM `act` where `ACT_type`='$act'";
...
?>
             ...
             <div class="title-heavy"></div> 
                ...
                <table><tr><td COLSPAN='3' ROWSPAN='5'><figure class="thumbnail"> <?php echo $rs['ACT_photo']?> width='150t'></figure></td>
                 
                <td  COLSPAN='8' span style='font-size:15pt;'><a href ="<?php echo $rs['ACT_web']?>"><?php echo $rs['ACT_name']?></a></td> 
                ...
                <tr ><td colspan='8'>報名日期: <?php echo $rs['ACT_regtime']?></td>
                    <td colspan='2' align="right"><?php echo $rs['ACT_toll']?></td></tr>
                
                <tr><td colspan='10' style="border:2px #e0e0d1  solid;"><?php echo $rs['ACT_content']?></td></tr>
                
                <!--<tr><td colspan='2'>詳細內容</td>-->
                 <tr><td colspan='10' align="right" ><?php echo $rs['ACT_type']?></td></tr>
