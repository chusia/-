...
<table width="682" border="1">
  <tr><td  rowspan="10" width="170"><img src="photo/7.png" width="150"></td></tr>
  <tr><td></td>
...
?>
 ...
 <P><a href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../img/11.png
	...
	<?php include_once('AQIRemind.php');?></aside><aside id="hot_post-3" class="widget widget_hot_post"><h3 class="widget-title"><p><i class="icon-st"></i></p>我的最愛</h3>
