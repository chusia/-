...
<?php include_once('Login/User.php'); //登入欄位?>
	...
	<nav class="crumbs">現在位置： <a title="返回首頁" href="">首頁</a> &gt; <a href="" title="">氣象物候</a> </nav> 
	...
	<script src="js/weather.php"></script>
	<div class="box">
	        <div class="lef">
	            <div id="title" ></div>
	            <div id="date_today" class="cont"></div>
	            <div id="wx_today" class="cont"></div>
	            <div id="T_today" class="cont"></div>
	            <div id="wind_today" class="cont"></div>
	            <div id="pop_today" class="cont"></div>
	            <div id="UVI1_today" class="cont"></div>
	            <div id="UVI2_today" class="cont"></div>
	        </div>
	        <div class="righ">
	            <select id="region" onchange="change_info();"></select>
	            <div id="l1_n1"></div>
	            <div id="l2_n1"></div>
	            <div id="hr_n1"></div>
   ...
   <section class="content" onMouseOut="this.className='content'" onMouseOver="this.className='content-m'"> 
	...
	<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">春季</a></h1> 
	...
	<figure class="thumbnail"> 
	<a href="recipe/24_1.php"><img src="img/s1/1.png
                        " alt="Gallery" ></a><p>立春</p>
	</a> 
	</figure>
     <!--
    ======================================================
    --> 
   <figure class="thumbnail"> 
	<a href="recipe/24_2.php"><img src="img/s1/2.png
                        " alt="Gallery" ></a><p>雨水</p>
	</a> 
	</figure>
     <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_3.php"><img src="img/s1/3.png
                        " alt="Gallery" ></a><p>驚蟄</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_4.php"><img src="img/s1/4.png
                        " alt="Gallery" ></a><p>春分</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
   <figure class="thumbnail"> 
	<a href="recipe/24_5.php"><img src="img/s1/5.png
                        " alt="Gallery" ></a><p>清明</p>
	</a> 
	</figure> 
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_6.php"><img src="img/s1/6.png
                        " alt="Gallery" ></a><p>穀雨</p>
	</a> 
	</figure> 
	</figure> 
	<div class="entry-site"> 
	...
	<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">夏季</a></h1> 
	...
	<div class="entry-content" style="text-align:center;"> 
	<figure class="thumbnail"> 
	<a href="recipe/24_7.php"><img src="img/s1/7.png
                        " alt="Gallery" ></a><p>立夏</p>
	</a> 
	</figure> 
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_8.php"><img src="img/s1/8.png
                        " alt="Gallery" ></a><p>小滿</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_9.php"><img src="img/s1/9.png
                        " alt="Gallery" ></a><p>芒種</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_10.php"><img src="img/s1/10.png
                        " alt="Gallery" ></a><p>夏至</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_11.php"><img src="img/s1/11.png
                        " alt="Gallery" ></a><p>小暑</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_12.php"><img src="img/s1/12.png
                        " alt="Gallery" ></a><p>大暑</p>
	</a> 
	</figure>
	<div class="entry-site"> 
	...
	<div class="entry-content" style="text-align:center;"> 
 <figure class="thumbnail"> 
	<a href="recipe/24_13.php"><img src="img/s1/13.png
                        " alt="Gallery" ></a><p>立秋</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_14.php"><img src="img/s1/14.png
                        " alt="Gallery" ></a><p>處暑</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_15.php"><img src="img/s1/15.png
                        " alt="Gallery" ></a><p>白露</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_16.php"><img src="img/s1/16.png
                        " alt="Gallery" ></a><p>秋分</p>
	</a> 
	</figure>
    <!--
    ======================================================
    ...
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_17.php"><img src="img/s1/17.png
                        " alt="Gallery" ></a><p>寒露</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_18.php"><img src="img/s1/18.png
                        " alt="Gallery" ></a><p>霜降</p>
	</a> 
	</figure>
	<div class="entry-site"> 
	...
	<div class="title-heavy"></div> 
	<h1 class="entry-title"><a href="" rel="bookmark" title="詳細閱讀 立春">冬季</a></h1> 
	...
	<div class="entry-content" style="text-align:center;"> 
 <figure class="thumbnail"> 
	<a href="recipe/24_19.php"><img src="img/s1/19.png
                        " alt="Gallery" ></a><p>立冬</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_20.php"><img src="img/s1/20.png
                        " alt="Gallery" ></a><p>小雪</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_21.php"><img src="img/s1/21.png
                        " alt="Gallery" ></a><p>大雪</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_22.php"><img src="img/s1/22.png
                        " alt="Gallery" ></a><p>冬至</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_23.php"><img src="img/s1/23.png
                        " alt="Gallery" ></a><p>小寒</p>
	</a> 
	</figure>
    <!--
    ======================================================
    -->
    <figure class="thumbnail"> 
	<a href="recipe/24_24.php"><img src="img/s1/24.png
                        " alt="Gallery" ></a><p>大寒</p>
	</a> 
	</figure>
	<div class="entry-site"> 
...
<script type='text/javascript'>
 ...
 <P><a href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/11.png
	...
	<div class="clear"></div></aside><aside id="hot_post-3" class="widget widget_hot_post"><h3 class="widget-title"><p><i class="icon-st"></i></p>心靈雞湯</h3>
	<div id="hot_post_widget">
	<?php include_once('ChickenSoup.php');?>
	</div>
	<script type="text/javascript">
	function setSN(e){
