...
$data_json = file_get_contents('https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-091?Authorization=CWB-05CC19A5-234E-448D-B2C8-31F793FE109F&elementName=Wx,MinT,MaxT,Wind,PoP,UVI&sort=time&format=json',false, stream_context_create($arrContextOptions));
?>
...
{
    document.getElementById("title").innerHTML = data_region[id].region + "天氣預測<br>　<br>　";
